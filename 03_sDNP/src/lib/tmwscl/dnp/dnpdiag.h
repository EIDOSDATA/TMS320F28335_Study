...
#define DNPDIAG_SHOW_AUTH_ERROR(pSession, userNumber, linkId, sequenceNumber, errorCode, pTimeStamp, pErrorText, textLen, isEvent, direction) \
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(sequenceNumber); TMWTARG_UNUSED_PARAM(userNumber); \
  TMWTARG_UNUSED_PARAM(linkId); TMWTARG_UNUSED_PARAM(errorCode); TMWTARG_UNUSED_PARAM(pTimeStamp); \
  TMWTARG_UNUSED_PARAM(pErrorText); TMWTARG_UNUSED_PARAM(textLen); TMWTARG_UNUSED_PARAM(isEvent); TMWTARG_UNUSED_PARAM(direction);

#define DNPDIAG_AUTH_ENCRYPT_PLAIN(pSession, pData, length, direction) \
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(pData); TMWTARG_UNUSED_PARAM(length); TMWTARG_UNUSED_PARAM(direction);

#define DNPDIAG_AUTH_ENCRYPT_CYPHER(pSession, pData, length, direction) \
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(pData); TMWTARG_UNUSED_PARAM(length); TMWTARG_UNUSED_PARAM(direction);

#define DNPDIAG_AUTH_PLAIN(pSession, pData, length, direction) \
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(pData); TMWTARG_UNUSED_PARAM(length); TMWTARG_UNUSED_PARAM(direction);

#define DNPDIAG_AUTH_HASHED(pSession, pData, length, direction) \
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(pData); TMWTARG_UNUSED_PARAM(length); TMWTARG_UNUSED_PARAM(direction);
...
#define DNPDIAG_SHOW_AUTH_UPDKEYCHGREQ(pSession, nameLength, pName, keyChangeMethod, challengeLength, pChallenge, direction)\
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(nameLength); TMWTARG_UNUSED_PARAM(pName); TMWTARG_UNUSED_PARAM(keyChangeMethod);\
  TMWTARG_UNUSED_PARAM(challengeLength); TMWTARG_UNUSED_PARAM(pChallenge); TMWTARG_UNUSED_PARAM(direction);

#define DNPDIAG_SHOW_AUTH_UPDATEKEYCHANGE(pSession, userNumber, sequenceNumber, length, pData, direction)\
  TMWTARG_UNUSED_PARAM(pSession); TMWTARG_UNUSED_PARAM(userNumber); TMWTARG_UNUSED_PARAM(sequenceNumber);\
  TMWTARG_UNUSED_PARAM(length); TMWTARG_UNUSED_PARAM(pData); TMWTARG_UNUSED_PARAM(direction);
...
#define DNPDIAG_SHOW_AUTH_ERROR(pSession, userNumber, linkId, sequenceNumber, errorCode, pTimeStamp, pErrorText, textLen, isEvent, direction) \
  dnpdiag_showAuthError(pSession, userNumber, linkId, sequenceNumber, errorCode, pTimeStamp, pErrorText, textLen, isEvent, direction)

#define DNPDIAG_AUTH_ENCRYPT_PLAIN(pSession, pData, length, direction) \
  dnpdiag_authEncryptPlain(pSession, pData, length, direction);

#define DNPDIAG_AUTH_ENCRYPT_CYPHER(pSession, pData, length, direction) \
  dnpdiag_authEncryptCypher(pSession, pData, length, direction);

#define DNPDIAG_AUTH_PLAIN(pSession, pData, length, direction) \
  dnpdiag_authPlain(pSession, pData, length, direction);

#define DNPDIAG_AUTH_HASHED(pSession, pData, length, direction) \
  dnpdiag_authHashed(pSession, pData, length, direction);
...
#define DNPDIAG_SHOW_AUTH_UPDATEKEYCHANGE(pSession, userNumber, sequenceNumber, length, pData, direction)\
  dnpdiag_authUpdKeyChange(pSession, userNumber, sequenceNumber, length, pData, direction); 
...
extern "C" {
  ...
  */
  ...
  /* function: dnpdiag_authEncryptPlain
   * purpose: display  
   * arguments:
   *  pSession - session from which this message originated
   * returns:
  ...
  /* function: dnpdiag_authEncryptCypher
   * purpose: display  
   * arguments:
   *  pSession - session from which this message originated
   * returns:
