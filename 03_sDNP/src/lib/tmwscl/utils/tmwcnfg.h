...
#include "tmwscl/config/tmwprvt.h"
 ...
 /* Include private definitions for internal TMW applications
 * SCL customers should not define TMW_USE_GATEWAY_DEFINES
 */
#define TMWCNFG_USE_SIMULATED_DB       TMWDEFS_FALSE
#define TMWCNFG_USE_GATEWAY_DB         TMWDEFS_TRUE
 ...
 */
#define TMWCNFG_SUPPORT_DIAG          TMWDEFS_FALSE     //TMWDEFS_TRUE
 ...
 */
#define TMWCNFG_SUPPORT_STATS         TMWDEFS_FALSE     //TMWDEFS_TRUE
 ...
 * precision floating point. 
 */
#define TMWCNFG_SUPPORT_DOUBLE        TMWDEFS_FALSE     //TMWDEFS_TRUE
 ...
 */
#define TMWCNFG_SIM_USE_DOUBLE        TMWDEFS_FALSE     //TMWDEFS_TRUE
 ...
 */
#define TMWCNFG_SUPPORT_THREADS       TMWDEFS_FALSE     //TMWDEFS_TRUE

/* Define whether or not multiple timer queues, one for each thread are
 ...
 * timer queue for each thread (one channel per thread). This allows the timer
 * callback functions to be run in the context of the channel thread. Setting 
 ...
 * timers through a call to tmwtarg_startMultiTimer().
 */
...
#define TMWCNFG_SUPPORT_ASYNCH_DB     TMWDEFS_FALSE     //TMWDEFS_TRUE
#endif
...
#define TMWCNFG_USE_SIMULATED_DB       TMWDEFS_FALSE        //TMWDEFS_TRUE
#endif
 ...
 * to TMWDEFS_FALSE
 */
#define TMWCNFG_USE_SIMULATED_CRYPTO     TMWDEFS_FALSE//TMWDEFS_TRUE
 ...
 */
#define TMWCNFG_USE_SIMULATED_CRYPTO_DB  TMWDEFS_FALSE      //TMWDEFS_TRUE

/* Use OpenSSL implementation for tmwcrypto interface */
 ...
 */
#define TMWCNFG_USE_DYNAMIC_MEMORY    TMWDEFS_FALSE         //TMWDEFS_TRUE
 ...
 */ 
#define TMWCNFG_MAX_APPLRCVS          5                     //64
 ...
 */
#define TMWCNFG_MAX_APPLICATIONS      1                     //TMWDEFS_NO_LIMIT

/* Specify the maximum number of channels that can be open at once.
 */
#define TMWCNFG_MAX_CHANNELS          4                     //TMWDEFS_NO_LIMIT

/* Specify the maximum number of sessions that can be open at once.
 */
#define TMWCNFG_MAX_SESSIONS          4                     //TMWDEFS_NO_LIMIT
 ...
 */
#define TMWCNFG_MAX_APPL_MSGS         5                     //TMWDEFS_NO_LIMIT
