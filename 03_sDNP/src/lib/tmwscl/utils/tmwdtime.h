...
typedef struct TMWDateTime
{
  ...
  TMWTYPES_USHORT TMWDEFS_GLOBAL tmwdtime_computeDayOfYear(
    const TMWDTIME *pDateTime);

  TMWTYPES_UCHAR TMWDEFS_GLOBAL tmwdtime_computeDayOfWeek(
    const TMWDTIME *pDateTime);
   ...
   */
  TMWTYPES_INT TMWDEFS_GLOBAL tmwdtime_compareTime(
    TMWDTIME *time1, 
    TMWDTIME *time2);
