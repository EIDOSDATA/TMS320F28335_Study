...
// Constructor
Win232Channel::Win232Channel(const WIN232_CONFIG &config, TMWTARG_CONFIG *pTmwTargConfig)
{
...
{
  const WIN232_CONFIG *p232Config = (WIN232_CONFIG *)pConfig;
  ...
  const void *pUserConfig)
{
  ...
  m_config.disabled = pIOConfig->win232.disabled;

  if (pIOConfig->win232.chnlName != NULL)
  {
    strncpy(m_config.chnlName, pIOConfig->win232.chnlName, WINIOTARG_STR_LEN);
  }
