...
{ 
  ...
  if((p120Event->sdnp.classMask & classMask) != 0)
  {
    ...
    /* Diagnostics */
    DNPDIAG_SHOW_AUTH_ERROR(p120Event->sdnp.pSession, p120Event->sdnp.point, p120Event->assocId, p120Event->sequenceNumber, p120Event->errorCode, &p120Event->sdnp.timeStamp, TMWDEFS_NULL, 0, TMWDEFS_TRUE, 0);
