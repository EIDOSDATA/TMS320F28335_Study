...
extern "C" {
  ...
  */
  ...
  /* WinIoTarg_setUseConnectorThread */
  /**
  *   set to true to use a seperate thread to establish connections
  * 
  *   @param pContext Context returned from call to WinIoTarg_Create()
  *   @param flag true to use seperate thread
  * 
  *   @remarks This applies to Master Stations (i.e. Clients)
  */
  WINIOTARG_API void WinIoTarg_setUseConnectorThread(
    void *pContext,
    TMWTYPES_BOOL flag);
